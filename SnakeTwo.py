...
class App:
    ...
    def on_init(self):
        ...
        if self.times_played % 2 == 0:
            self._background_image = pygame.image.load("field.png").convert()
        else:
            self._background_image = pygame.image.load("ice.png").convert()
    ...
    def on_execute(self):
        ...
        while (self._running):
            ...
            if int(self.count) < 5:
                ...
                time.sleep(200.0 / 10000.0);
            elif int(self.count) >= 50:
                time.sleep(150.0 / 10000.0);
        self.on_cleanup()
